                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <a class="btn btn-sm btn-primary" href="{{ route('produk.create') }}"><i
                            ...
                            <table id="dataTable" class="table nowrap table-striped table-bordered" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-ordering="true">Merk</th>
                                        <th data-ordering="true">Harga Beli</th>
                                        <th data-ordering="true">Harga Jual</th>
                                        <th data-ordering="true">Diskon</th>
                                        <th data-ordering="true">Stok</th>
                                ...
                                <tbody>
                                    @foreach ($produk as $prod)
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge bg-info">{{ $prod->kode_produk }}</span>
                                            </td>
                                            ...
                                            @else
                                                <td>-</td>
                                            @endif
                                            <td>Rp. {{ format_uang($prod->harga_beli) }}</td>
                                            <td>Rp. {{ format_uang($prod->harga_jual) }}</td>
                                            <td>{{ $prod->diskon }}</td>
                                            <td>{{ $prod->stok }}</td>
                                            <td>
                                                <a href="{{ route('produk.edit', $prod->id_produk) }}"
                                                    class="btn btn-sm btn-success"><i
                                                        class='bx bxs-edit fs-16 align-middle'></i>
                                                    Edit</a>
                                                <a data-bs-toggle="modal"
                                                    data-bs-target="#modalHapus{{ $prod->id_produk }}"
                                                    class="btn btn-sm btn-danger"><i
                                                        class='bx bx-trash fs-16 align-middle'></i> Hapus</a>
                                                @include('modal.hapus-produk')
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
