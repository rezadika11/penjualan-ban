                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            ...
                            {{-- <a class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#modalSupplier"><i
                                    class='bx bxs-plus-square fs-18 align-middle'></i> Transaksi Baru</a> --}}
                            <table>
                                <tr>
                                    <td>Supplier</td>
                                    <td>: {{ $supplier->nama }}</td>
                        ...
                        <div class="card-body">
                            ...
                            <table class="table nowrap table-striped table-bordered table-pembelian mb-5"
                                style="width:100%">
                                <thead>
                                    <tr>
