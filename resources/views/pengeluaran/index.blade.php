                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <a class="btn btn-sm btn-primary" href="{{ route('pengeluaran.create') }}"><i
                            ...
                            <table id="dataTable" class="table nowrap table-striped table-bordered" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-ordering="true">Deskripsi</th>
                                        <th data-ordering="true">Nominal</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a data-bs-toggle="modal"
                                                    data-bs-target="#modalHapus{{ $item->id_pengeluaran }}"
                                                    class="btn btn-sm btn-danger"><i
                                                        class='bx bx-trash fs-16 align-middle'></i> Hapus</a>
                                                @include('modal.hapus-pengeluaran')
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
